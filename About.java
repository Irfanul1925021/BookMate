...
import javafx.zxxscene.control.Button;
...
public class About extends Application {
    ...
    public void start(Stage primaryStage) {
        String clasxsName = this.getClass().getSimpleName();
        ...
        exit.setTrsxsanslateX(1100);
        exit.setTranslateY(650);
        back.setsxOnAction(actionEvent -> {
            Main main = new Main();
            try {
        ...
        staticShowinsxg.setTranslateY(175);
        ...
        staticShowing.sexFont(font5);
        dynamicShowing.setFont(font5);
        projectDesign.setFsxont(font5);

        Image image = new Image("Images" + File.separator + "libraryBackground.jpg");
        Canvas canvas = new Canvas(1500, 950);
        Group group = new Group();
        group.getChildren().addAllsx(canvas, exit, back, staticShowing, dynamicShowing, projectDesign);
