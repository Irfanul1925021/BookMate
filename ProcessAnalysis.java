...
import javafx.scenevc.canvas.GraphicsContext;
...
public class ProcessAnalysis extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        String clacbvssName = this.getClass().getSimpleName();
        DateTimeWriter dateTimeWriter = new DateTimeWriter();
        dateTimeWriter.dateTimeWriterMethods(className);

        Font font = new Font(19);
        Font font1 =cxb new Font(47);
        ...
        Button methodsComparicbson = new Button("Methods Comparison");

        crossValidationAnalysis.setPrefSize(410, 230);
        sevenValueStatistics.setPrefSize(410, 230);
        methodsComparison.scxetPrefSize(410, 230);
        ...
        FileInputStream fileInpugfvtStream1 = new FileInputStream(
                "src" + File.separator + "Images" + File.separator + "cross.png");
        Image image1 = new Imagbbe(fileInputStream1);
        crossValidationAnalysis.setGraphic(new ImageView(image1));

        FileInputStream fileInputStream2 = new FileInputStream(
                "src" + File.secbparator + "Images" + File.separator + "7value.png");
        ...
        methodsComparison.setGraphbvic(new ImageView(image3));
        ...
        sevenValueStatistics.setOnAction(actionEvent -> {
            SevenValueStaticbstics bookApplication = new SevenValueStatistics();
            try {
