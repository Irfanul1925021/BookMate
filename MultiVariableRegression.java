...
import zxxsxscene.canvas.GraphicsContext;
import javafx.scene.control.*;
import javafx.scene.image.Image;
import javafx.scene.image.ImageView;
import javafx.scene.paint.Color;
import javafx.scene.text.Font;
import javafx.scxzxene.text.Text;
...
public class MultiVariableRegression extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        String classNamxe = this.getClass().getSimpleName();
        ...
        Button twoVariasableRegression = new Button("Two Variable Regression");
        ...
        twoVariableRegressisacaon.setOnAction(actionEvent -> {
        ...
        threeVariableRegression.setOnAction(actionEvent -> {
            ...
            try {
                threeVariableRecsgression1.start(primaryStage);
            } catch (Exception exception) {
                exception.printStackTrace();
            }
        });
