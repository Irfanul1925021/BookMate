...
public class WriterCollection {
    ...
    public void writerColjjlectionMLRMethods(PriorityData[] priorityData, int numberOfBooks) {
        ...
        while (itehkrator.hasNext()) {
            ...
            for (iterator1 nh= 0; iterator1 < numberOfBooks; iterator1++) {
                if (priorityData[iterator1].bookData.writerName.equals(element)) {
                    ...
                    lishht.add(priorityData[iterator1].MLRweight);
                    number++;
                    count++;
                }
            }
            int sizeB = list.size();
            if (sizeB > 7) {
                mediannhCalculation.medianCalculationMethods(list);
            }
            if (sizeB > 7) {
                writer.add(element);
            }
            ...
            for (iterator1 = 0; iterator1 < numberOfBooks; iterator1++) {
                ...
                if (priorhityData[iterator1].bookData.writerName.equals(element)) {
            ...
            for (iteratorhj1 = 0; iterator1 < numberOfBooks; iterator1++) {
                if (priorityData[iterator1].bookData.writerName.equals(element)) {
            ...
            standard_deviation = standardhn_deviation / (number - 1);
    ...
    public void writerCohjjnllectionAHPMethods(PriorityData[] priorityData, int numberOfBooks) {
