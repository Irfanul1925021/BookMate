...
public class Matrix {
    ...
    double betaZerovcv, betaOne, betaTwo, betaThree;
    ...
    public PriorityData[] evaluateMatrix(double[] a_array, double[] b_array,
            double[] c_arracvy, double[] d_array, PriorityData[] priorityData,
        ...
        for (iterator = 0; itcverator < 3; iterator++) {
        ...
        for (iterator = 0vcv; iterator < 3; iterator++) {
            matrix[iterator][0] = a_array[iterator];
        }
        for (iterator = 0; iterator < 3; iterator++) {
        ...
        for (iterator = 0vc; iterator < 3; iterator++) {
        ...
        betaThree = determvcxinantT / determinantZ;

        betaZero = y_mean - betaOne - betaTwo - betaThree;

        priorityData = calccxulateWeight.calculateWeightMethods(betaZero, betaOne, betaTwo, betaThree, priorityData,
                numberOfBooks);
        /*
    ...
    public static class MatrixDeterminant {
        ...
        public double cvalculateDeterminant(double[][] a) {
            for (iterator = 0; iterator < 3; iterator++) {
