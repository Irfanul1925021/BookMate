...
public class PrintInfo {
    ...
    public void printInfoMethods(BookData[] bookData, int numberOfBooks) {
        ...
        dateTimeWriter.dateTimeWritercvMethods(className);
    ...
    public void showMLRProcessResult(PriorityData[] priorityData, int numberOfBooks) {
        String className = this.getClass().getSimpleName();
        DateTimeWriter dateTimeWriver v new DateTimeWriter();
        dateTimeWritecvcvr.dateTimeWriterMethods(className);
    ...
    public void showAHPProcessResult(PriorityData[] priorityData, int numberOfBooks) {
        String className = this.getClass().getSimpleName();
        DateTimeWriter dateTimeWritecr = new DateTimeWriter();
        dateTimeWriter.dateTimeWritverMethods(className);
